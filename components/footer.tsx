    ...
    <footer className="bg-muted/50 border-t">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground text-pretty leading-relaxed mb-4">
              Curium-808 transforme les défis technologiques en opportunités de croissance grâce à des solutions sur
              mesure, sécurisées et conçues avec passion.
            </p>
        ...
        <div className="border-t mt-8 pt-8 text-center text-muted-foreground">
          <p>&copy; 2025 Curium-808 SARL. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  )
