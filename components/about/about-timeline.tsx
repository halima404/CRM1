              ...
              {milestones.map((m, i) => (
                ...
                >
                  <div className="w-full md:w-1/2">
                    <div className="milestone opacity-0 translate-y-4 transition-all duration-700 bg-white/80 backdrop-blur-sm border border-gray-100 rounded-3xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-2">
